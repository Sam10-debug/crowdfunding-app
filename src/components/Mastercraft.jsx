...
const Mastercraft = () => {
  return (
	<section className=" flex relative bg-slate-100 flex-col items-center w-[90%] md:w-1/2 px-4 py-8 rounded-md">
		...
		<h1 className=" text-center font-bold text-[32px]"><span>Mastercraft</span> <span>Bamboo</span> <span>Monitor</span><span className="ml-1"> Riser</span></h1>
		...
		<div className=" flex justify-between w-[90%] py-4">
			<button className="green-btn  px-6 py-2 rounded-full font-semibold text-white">Back this Project</button>
			<button className="bookmark-btn font-semibold flex relative  px-4 md:px-16  md:py-4 rounded-full"><svg className="absolute top-[-25%] md:top-0 left-0" width="56" height="56" xmlns="http://www.w3.org/2000/svg"><g fill="none" fillRule="evenodd"><circle fill="#2F2F2F" cx="28" cy="28" r="28"/><path fill="#B1B1B1" d="M23 19v18l5-5.058L33 37V19z"/></g></svg><span className="hidden md:flex">Bookmark</span></button>
		</div>
	</section>
  )
}
