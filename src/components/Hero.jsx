...
const Hero=()=>{
	...
	return (
		<section className="hero h-[25vh] relative ">
			<header className=" flex px-4 md:px-14 py-4 justify-between">
				<div className="">
				...
				<nav className="z-50 hidden md:flex" ref={hamburgerRef}>
					<ul className="flex flex-col  md:flex-row">
						<li className="font-bold cursor-pointer md:text-white md:font-normal px-2 py-2 md:py-0 border-b-2 md:border-b-0">About</li>
						<li className="font-bold cursor-pointer md:text-white md:font-normal px-2 py-2 md:py-0 border-b-2 md:border-b-0">Discover</li>
						<li className="font-bold cursor-pointer md:text-white md:font-normal px-2 py-2 md:py-0">Get Started</li>
					</ul>
				</nav>
				<div className="flex md:hidden">
				<svg onClick={ShowNav}  width="16" height="15" xmlns="http://www.w3.org/2000/svg"><g fill="#FFF" fillRule="evenodd"><path d="M0 0h16v3H0zM0 6h16v3H0zM0 12h16v3H0z"/></g></svg>
				</div>
			</header>
		</section>
	)
